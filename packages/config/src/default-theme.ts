...
export const defaultTheme: Theme = {
  ...
  active: true,
  tokens: {
    // Paleta del sitio original (SEGA/ServMaq): marino + azul royal + amarillo del logo
    colors: {
      light: {
        primary: '#2B5BE2',
        primaryFg: '#FFFFFF',
    ...
    sections: [
      ...
      { key: 'home.success-cases', enabled: true, order: 9 },
      { key: 'home.faq', enabled: true, order: 10 },
    ],
    quoteMode: false,
  },
  copys: {
